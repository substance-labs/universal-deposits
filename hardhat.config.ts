...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    gnosisFork: {
      url: vars.get('GNOSIS_MAINNET_URL'),
    },
    arbitrumFork: {
      url: vars.get('ARBITRUM_MAINNET_URL'),
    },
    localhost: {
    ...
    sxTestnet: {
      chainId: 79479957,
      url: vars.get('SX_TESTNET_URL', 'https://rpc.sx-rollup-testnet.t.raas.gelato.cloud'),
      accounts,
      ledgerAccounts,
    },
    sxMain: {
    ...
    inkTestnet: {
      chainId: 763373,
      url: vars.get('INK_TESTNET_URL', 'https://rpc-gel-sepolia.inkonchain.com'),
      accounts,
      ledgerAccounts,
    },
    inkMain: {
    ...
    morphTestnet: {
      chainId: 2810,
      url: vars.get('MORPH_TESTNET_URL', 'https://rpc-quicknode-holesky.morphl2.io'),
      accounts,
      ledgerAccounts,
    },
    morphMain: {
    ...
    etherlinkTestnet: {
      chainId: 128123,
      url: vars.get('ETHERLINK_TESTNET_URL', 'https://node.ghostnet.etherlink.com'),
      accounts,
      ledgerAccounts,
    },
    etherlinkMain: {
      chainId: 42793,
      url: vars.get('ETHERLINK_MAINNET_URL', 'https://node.mainnet.etherlink.com'),
      accounts,
      ledgerAccounts,
    },
    soneiumTestnet: {

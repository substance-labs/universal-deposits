...
import { SafeModule__factory, ISafeTest__factory, TestToken, TestToken__factory } from '../../typechain-types'
...
export default async function setup() {
  ...
  const allowanceModule = SafeModule__factory.connect(allowanceModuleAddress, relayer)
